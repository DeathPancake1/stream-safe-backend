...
import { UploadFileChatDto } from './dto/upload-file-chat.dto';
...
export class FilesService {
    ...
    async uploadFile(videoInfo: UploadFileChatDto, file: Express.Multer.File, emailFromToken: string): Promise<SavedFile> {
        try {
            if (!videoInfo || !file) {
